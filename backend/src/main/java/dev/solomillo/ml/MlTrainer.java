...
public class MlTrainer {
    ...
    public MlTrainer(
        ModeloPredictivoRepository repo,
    ...
    public ModeloPredictivo entrenarResultado() throws Exception {
        List<Partido> finalizados = partidoRepo
            .findByEstadoOrderByFechaHoraAsc(EstadoPartido.FINALIZADO)
            .stream()
    ...
    private ModeloPredictivo persistir(
        String nombre,
        String tipo,
        Classifier clf,
        double acc,
        ...
        System.out.println("GUARDANDO MODELO EN: " + props.modelsDir);
